...
export const en = {
  meta: {
    ...
    lexicon: {
      title: "Campus Lexicon | WELCOM’",
      description: "Complete glossary and lexicon of campus acronyms, student slang, places, and associations at Télécom SudParis & IMT-BS in Évry.",
    },
  },
  nav: {
    home: "Home",
  ...
  lexicon: {
    ...
    "Rue Étoile": "The avenue located between the Forum, Nova building, administration building, and Étoile building.",
    "Bâtiment Étoile": "The campus building housing the Étoile amphitheater, the largest amphitheater on campus.",
    ...
    GS: "The Great Hall (Grande Salle), the bar room located to the right when entering through the main entrance of the foyer.",
    "Espace T": "Espace Triangle, located right outside the Great Hall.",
    ...
    "Club B": "The weekly free student party on campus, organized by BPM and AbsINThe. The name comes from the old disbanded club Club Bière.",
    WES: "Week-End Ski, the big promo ski weekend organized by ASINT for the entire class.",
    "1A": "First year student or first academic year.",
    "1B": "First year repeating student.",
    PS: "Petite Salle (Small Hall), located right at the center of the foyer.",
    TiJET: "Room of the BPM Club Sono association (DJing, sound engineering, and lighting).",
    Lister: "Participating in a campaign as part of an association election campaign list.",
    CF1: "Contrôle Final 1, the first session of final exams at the end of a semester.",
    CF2: "Contrôle Final 2, the make-up exam session (rattrapages).",
    RTC: "Rules The Campus, a popular expression used to highlight an association or event that dominates campus life.",
    Youyou: "The official mascot of ASINT (Sports Association).",
    Boris: "The official mascot of BDA (Arts Office).",
    fallback: "A campus slang word.",
  },
  lexiconPage: {
    title: "Campus Lexicon",
    subtitle: "Every campus acronym, place, association, and piece of student jargon explained in plain language.",
    searchPlaceholder: "Search a term, acronym, or definition...",
    filterAll: "All Terms",
    filterPlaces: "Places & Campus",
    filterAssociations: "Clubs & Associations",
    filterLife: "Student Life & Traditions",
    filterAcademic: "Academic & Admin",
    noResultsTitle: "No matching terms found",
    noResultsText: "Try searching for another keyword like RER, Foyer, or MiNET.",
    termsCount: "terms cataloged",
  ...
  gettingHere: {
    ...
    virtualTourBadge: "360° Virtual Tour",
    virtualTourTitle: "Explore the campus interactively",
    virtualTourDesc: "A complete 360° immersive tour of campus buildings, lecture halls, and student spaces.",
    virtualTourCta: "Launch 360° Tour",
  ...
  housing: {
    ...
    roomsNoiseWarningTitle: "NOISE WARNING FOR BUILDINGS U1, U2, U4 & U7",
    roomsNoiseWarningBody: "Buildings U1, U2, and U4 are directly adjacent to the {Foyer} student center and the {AbsINThe} campus bar. As a result, these buildings experience considerable noise during parties and evening student events (especially Wednesday nights). If you require a quiet environment for study or sleep, please keep this in mind when choosing your building!<br /><br /><strong>U7 Tip:</strong> Avoid picking rooms facing the national road (very noisy), which are rooms 7X21 to 7X35.",
  ...
  guidesPage: {
    ...
    "clubBTitle": "Club B",
    "clubBLede": "The {Club B} is the weekly free party on campus, organized by <strong>BPM</strong> (sound & light club) and {AbsINThe} (student bar). Held in the {GS} (Great Hall) or outdoors at {Espace T}.",
